    ...
    <div class="w-4/5 m-auto pt-20">
        <form action="/blog/{{$post->slug}}"
            ...
            <input type="text" name="title" value="{{$post->title}}"
                class="bg-transparent block border-b-2 w-full h-20 test-6xl outline-none">
            ...
            <button type="submit"
                class="uppercase mt-15 bg-blue-500 text-gray-100 tx-lg font-extrabold py-4 px-8 rounded-3xl">
                Submit Post
            </button>
        </form>
